export const FRACTAL_AGENT_PROVIDERS = [
  {
    ...
    keyHint:
      "Used for Claude models. If you use Claude Code, your Pi OAuth subscription is detected automatically — no key needed.",
  ...
  },
  {
    ...
    keyHint: "Used for Gemini models.",
    keyPlaceholder: "...",
  },
  {
    id: "openai" as const,
    ...
    keyHint:
      "Used for GPT models. If you are logged into ChatGPT Plus/Pro via Pi, your subscription is detected automatically — no key needed.",
    keyPlaceholder: "sk-...",
  },
  {
  ...
  },
  {
    ...
    keyHint:
      "OpenCode Go API (deepseek, kimi, glm, mimo models). Uses OpenAI-compatible chat completions.",
    keyPlaceholder: "...",
  },
] as const;

export type FractalAgentProvider = string;

/**
 * Models available for the Fractal Agent, keyed by provider.
 *
 * These are derived from pi-ai's built-in model catalog where possible.
 * Some model IDs differ between AI SDK and pi-ai conventions.
 */
export const FRACTAL_AGENT_MODELS: Record<string, Array<{ id: string; label: string }>> = {
  anthropic: [
