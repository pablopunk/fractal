...
import { checkCleanupSafety, cleanupPromptById } from "~/lib/server/cleanup.js";
...
export const PATCH: APIRoute = async ({ params, request }) => {
  ...
  if (body.modelProfile === "fast" || body.modelProfile === "smart")
    patch.modelProfile = body.modelProfile;
  if (typeof body.presetId === "string") patch.presetId = body.presetId;
  if (
    body.column === "PROMPTS" ||
    body.column === "RUN_IN_PLACE" ||
