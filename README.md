...
- **Turn your ideas into prompts**. Write down all your thoughts, tackle later.
- **Worktrees**. Only when you need them.
- **Kanban style**. Drag and drop prompts like if they were tasks.
- **Review column**. PR tracking with CI status, review comments, merge conflicts.
...
- **Embedded terminal tabs**. xterm.js, per-project, reorderable, multiple themes.
